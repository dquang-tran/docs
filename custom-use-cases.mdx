...
Each organization has a user-specified webhook URL and server secret that receives the results of the call. We allow you to specify the shape of the data you expect to receive.

You can expect to receive a JSON object with the following shape after the call is completed:
