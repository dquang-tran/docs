...
<ParamField path="source" type="object" required>
  ...
  <Expandable>
    ...
    <ParamField path="fromParty" type="object" required>
      Party that initiated the communication
      <Expandable>
        <ParamField path="partyType" type="string" required>
    ...
    <ParamField path="toParty" type="object" required>
...
<ParamField path="carrier" type="object">
  ...
  <Expandable>
    ...
    <ParamField path="compliance" type="object">
      Compliance details
      <Expandable>
        <ParamField path="hwConnectionStatus" type="string">
          HighwayWise connection status
        </ParamField>
        <ParamField path="hwRulesAssessment" type="string">
